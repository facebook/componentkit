...
{
  CKDataSourceItem *firstItem = [[CKDataSourceItem alloc] initWithLayout:CKComponentLayout() model:@"model" scopeRoot:nil boundsAnimation:{}];
  ...
  CKDataSourceItem *secondItem = [[CKDataSourceItem alloc] initWithLayout:CKComponentLayout() model:@"model" scopeRoot:nil boundsAnimation:{}];
...
- (void)testNonEqualStates
{
  ...
  CKDataSourceItem *secondItem = [[CKDataSourceItem alloc] initWithLayout:CKComponentLayout() model:@"model2" scopeRoot:nil boundsAnimation:{}];
  CKDataSourceConfiguration *secondConfiguration =
  [[CKDataSourceConfiguration alloc] initWithComponentProvider:[CKDataSourceStateTests class]
                                                                             context:@"context"
                                                                           sizeRange:CKSizeRange()];
