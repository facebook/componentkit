...
- (void)testAsynchronouslyUpdatingStateOfComponentEventuallyUpdatesCorrespondingView_WithUnifiedBuildAndLayout
{
  CKComponentHostingView *hostingView = [[CKComponentHostingView alloc] initWithComponentProvider:[CKComponentHostingViewAsyncStateUpdateTests class]
                                                                                sizeRangeProvider:[CKComponentFlexibleSizeRangeProvider providerWithFlexibility:CKComponentSizeRangeFlexibleWidthAndHeight]
                                                                              componentPredicates:{}
...
- (void)testAsynchronouslyUpdatingStateOfComponentAndThenSynchronouslyUpdatingStateImmediatelyUpdatesCorrespondingView_WithUnifiedBuildAndLayout
{
  CKComponentHostingView *hostingView = [[CKComponentHostingView alloc] initWithComponentProvider:[CKComponentHostingViewAsyncStateUpdateTests class]
                                                                                sizeRangeProvider:[CKComponentFlexibleSizeRangeProvider providerWithFlexibility:CKComponentSizeRangeFlexibleWidthAndHeight]
                                                                              componentPredicates:{}
