...
- (void)testBoundsAnimationCorrectlyComputedWhenBuildingNewVersionOfComponent
{
  ...
  const CKBuildComponentResult firstResult = CKBuildComponent(CKComponentScopeRootWithListener(nil), {}, block);
...
- (void)testBoundsAnimationIsNotAppliedToNewlyCreatedViews
{
  ...
  const CKBuildComponentResult firstResult = CKBuildComponent(CKComponentScopeRootWithListener(nil), {}, ^{
