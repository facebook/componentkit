...
CKActionBase::CKActionBase(SEL selector,  id<CKTreeNodeComponentProtocol> component) noexcept : _target(nil), _block(NULL), _variant(CKActionVariant::Responder), _selector(selector)
{
