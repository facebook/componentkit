...
bool CKTypedComponentActionBase::operator==(const CKTypedComponentActionBase& rhs) const
{
  return (_variant == rhs._variant
          ...
          && _responderBlock == rhs._responderBlock
...
CKTypedComponentActionBase::CKTypedComponentActionBase() noexcept : _target(nil), _responderBlock(nil), _block(NULL), _variant(CKTypedComponentActionVariant::RawSelector), _selector(nullptr) {}

CKTypedComponentActionBase::CKTypedComponentActionBase(id target, SEL selector) noexcept : _target(target), _responderBlock(nil), _block(NULL), _variant(CKTypedComponentActionVariant::TargetSelector), _selector(selector) {};

CKTypedComponentActionBase::CKTypedComponentActionBase(const CKComponentScope &scope, SEL selector) noexcept : _target(nil), _responderBlock(scope.responderGenerationBlock()),  _block(NULL), _variant(CKTypedComponentActionVariant::Responder), _selector(selector)
{
  CKCAssert(_responderBlock, @"You are creating an action that will not fire because you have an invalid scope handle.");
};

CKTypedComponentActionBase::CKTypedComponentActionBase(SEL selector) noexcept : _target(nil), _responderBlock(nil), _block(NULL), _variant(CKTypedComponentActionVariant::RawSelector), _selector(selector) {};

CKTypedComponentActionBase::CKTypedComponentActionBase(dispatch_block_t block) noexcept : _target(nil), _responderBlock(nil), _block(block), _variant(CKTypedComponentActionVariant::Block), _selector(NULL) {};
