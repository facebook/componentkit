                            ...
                            UIImage *backgroundImage, UIEdgeInsets contentEdgeInsets)
{
  ...
  CGSize contentSize = {
    ceil(titleSize.width) + imageSize.width + contentEdgeInsets.left + contentEdgeInsets.right,
    MAX(ceil(titleSize.height), imageSize.height) + contentEdgeInsets.top + contentEdgeInsets.bottom
  };
