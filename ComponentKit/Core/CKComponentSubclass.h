...
/**
 ...
 @warning In almost all cases, prefer the use of CKComputeComponentLayout in RCLayout
...
/**
 ...
 @param constrainedSize A min and max size. This is computed as described in the description. The RCLayout you
