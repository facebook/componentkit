...
: newScopeRoot([previousScopeRoot newRoot]), stateUpdates(updates), stack(), isSystraceEnabled(false), buildTrigger(trigger), previousScope(CKThreadLocalComponentScope::currentScope())
{
